...
class Pretrained(Inference):
    ...
    def run(self, prompt: str,max_new_tokens=512, **args):
        ...
        print("generate with tokens : {}".format(max_new_tokens))
        output = self.model.generate(**tokenized_prompt, max_new_tokens=max_new_tokens, eos_token_id=terminators, **args)
