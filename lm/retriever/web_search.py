...
GOOGLE_API_KEY = "AIzaSyAgnkSb35XUmfTAtS6CiJ1qW0G3rEDrXsA"
GOOLE_CUSTOM_SEARCH_ENGINE_ID = "9610070cd00304838"
...
def web_search(input, graph: Graph):
    ...
    try:
        ...
        documents = search_in_documents(input["query"], documents)[0][0::5]
